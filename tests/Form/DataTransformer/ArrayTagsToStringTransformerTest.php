...
class ArrayTagsToStringTransformerTest extends TestCase
{
    /**
     ...
     */
    private function getMockedTransformer(array $findByReturnValues = []): ArrayTagsToStringTransformer
    {
        ...
        return new ArrayTagsToStringTransformer($tagRepository);
    }
